 ...
 */
export function parseJSDocComment(symbol, typeChecker, sourceFileOverride) {
 ...
 */
export function findNodeInSourceFile(sourceFile, nodeName, approximateLine) {
 ...
 */
export function parseJSDocText(commentText) {
    const result = {
        description: '',
        params: [],
        examples: []
 ...
 */
export function extractDestructuredParams(parsedDoc, paramName) {
 ...
 */
export function getParameterDocumentation(param, paramDecl, typeChecker) {
    const result = {
        description: ''
    };
