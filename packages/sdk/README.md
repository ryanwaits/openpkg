...
- `OpenPkg` analyzes TypeScript source files (`.ts`, `.tsx`). Ensure your project is built so declaration files and generated types are present when needed.
- Local analysis does not automatically execute build steps; run your package's build command first for best results.
