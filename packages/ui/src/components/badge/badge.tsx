...
const kindBadgeVariants = cva('inline-flex items-center justify-center font-mono font-medium rounded shrink-0', {
  variants: {
    kind: {
...
export interface KindBadgeProps extends React.HTMLAttributes<HTMLSpanElement>, VariantProps<typeof kindBadgeVariants> {
  label?: string;
}
